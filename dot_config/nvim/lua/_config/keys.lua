...
return {
  ...
  illuminate = {
    { "g]", function() require('illuminate').goto_next_reference(true) end, desc = "Next Reference" },
    { "g[", function() require('illuminate').goto_prev_reference(true) end, desc = "Prev Reference" },
  },
  mason = {
