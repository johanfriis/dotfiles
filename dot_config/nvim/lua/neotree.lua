return {
  ...
  config = function()
    ...
    vim.keymap.set('n', '§', ':Neotree action=focus source=buffers position=float toggle=true<cr>')
    vim.keymap.set('n', '<leader><e>', ':Neotree action=focus source=filesystem position=left toggle=true reveal=true<cr>')
  end
}
